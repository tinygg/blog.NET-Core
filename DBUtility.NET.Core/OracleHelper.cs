...
namespace KXNF.DBUtility
{
    ...
    public abstract class OracleHelper
    {
        ...
        public static readonly string ConnectionStringLocalTransaction = ConfigHelper.GetConfigFromJson("OraConnString1");
        public static readonly string ConnectionStringInventoryDistributedTransaction = ConfigHelper.GetConfigFromJson("OraConnString2");
        public static readonly string ConnectionStringOrderDistributedTransaction = ConfigHelper.GetConfigFromJson("OraConnString3");
        public static readonly string ConnectionStringProfile = ConfigHelper.GetConfigFromJson("OraProfileConnString");
        public static readonly string ConnectionStringMembership = ConfigHelper.GetConfigFromJson("OraMembershipConnString");

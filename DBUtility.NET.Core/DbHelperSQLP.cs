...
namespace DBUtility
{
    ...
    public class DbHelperSQLP
    {
        ...
        private static SqlCommand BuildIntCommand(SqlConnection connection, string storedProcName, IDataParameter[] parameters)
        {
            ...
            command.Parameters.Add(new SqlParameter("ReturnValue", SqlDbType.Int, 4, ParameterDirection.ReturnValue, 0, 0, string.Empty, DataRowVersion.Default, false, null, string.Empty, string.Empty, string.Empty));
            return command;
        }
        #endregion
